...
experimento_nb = Experimento([fold], ml_method=ml_nb_method, ClasseObjetivoOtimizacao = OtimizacaoObjetivoNaiveBayesCompeticao,
                    num_trials=5)
...
best_rndf = MetodoCompeticaoHierarquico(GaussianNB(), col_classe_prim_nivel="grouped_genre")
